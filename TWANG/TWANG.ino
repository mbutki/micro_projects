...
// BUTTONS
#define leftButtonPinNumber   15
#define rightButtonPinNumber  14
#define attackButtonPinNumber 16
...
void setup() {
    ...
    pinMode(attackButtonPinNumber, INPUT_PULLUP);
...
void getInput(){
    ...
    if(digitalRead(leftButtonPinNumber) == LOW) {
      joystickTilt = -90;
      Serial.println("left");
    } else if(digitalRead(rightButtonPinNumber) == LOW) {
      joystickTilt = 90;
      Serial.println("right");
    } else {
      joystickTilt = 0;
    }
    if(digitalRead(attackButtonPinNumber) == LOW) {
